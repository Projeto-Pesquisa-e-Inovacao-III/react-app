    ...
    return (
        <>
            <div className={styles.wrapperDashboardPersonal}>
                <div className={`${styles.wrapperElementsDashboard} ${isMobile && styles.dashMobile}`}>
                    <div className={`${styles.textDashboardPersonal}`}>
                        <h1>Desempenho</h1>
                        <h3>Acompanhe suas métricas e resultados</h3>
                    </div>
                    <div className={`${styles.kpisDashboardPersonal} ${isMobile ? styles.kpisDashboardPersonalMobile : ""}`}>
