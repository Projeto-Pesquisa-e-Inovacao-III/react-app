            ...
            <div className={styles.wrapperDashboardPersonal}>
                <div className={classnames(styles.wrapperElementsDashboard, { [styles.dashMobile]: isMobile })}>
                    ...
                    <div className={classnames(styles.kpisDashboardPersonal, { [styles.kpisDashboardPersonalMobile]: isMobile })}>
                        <KPICards isMobile={isMobile} isFull={!isMobile} title="Alunos com pacotes ativos" value={activeStudentsCount} description="Alunos ativos"
                        ...
                        <KPICards isMobile={isMobile} isFull={true} value={inactiveStudentsCount} title="Alunos sem pacotes ativos"
                        ...
                        <KPICards isMobile={isMobile} isFull={true} value={`${percentualInactiveStudents}%`} title="Percentual pacotes inativos"
