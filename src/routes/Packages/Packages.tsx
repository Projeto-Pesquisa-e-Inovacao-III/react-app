...
export function Packages() {
    ...
    return (
        <>
            ...
            {openModal === "edit" && (
                <AddPackagePlan title="Editar Pacote" typePackage="PACOTE" onClose={handleCloseModal} callSuccessModal={() => handleSuccessModalInfos("Edição concluída", "O pacote foi editado com sucesso")} />
            )}
