...
export default function HomeDesktop() {
    ...
    return (
        <>
            ...
            <div>
                {/* main */}
                <section className={"flex flex-col justify-center p-5 h-dvh  bg-[url('https://placehold.co/1920x1080')] bg-cover bg-center"}>
                    <div className="w-fit flex flex-col justify-center items-start gap-5 mt-64 ml-20 mr-20">
                        <h1 className={"w-[52.3%] text-5xl font-bold uppercase text-center "}>
                            Bem-vindo a csf Treinamentos
                        </h1>
                        <button className="bg-white mt-3 min-h-12 w-96 text-black font-semibold rounded-md">Lorem, ipsum.</button>
                    </div>
                </section>

                {/* about */}
                <section className="bg-oxford-blue flex justify-center p-5 pb-20 pt-20">
                    <div className="w-full flex ml-20 mr-20">
                        <div>
                ...
                <section className="mt-10 mb-10 p-5">
                    <div className="ml-20 mr-20">
                        <div className="flex justify-center items-center uppercase border-amber-600 wrapper-content mb-20">
                            <h1 className="ml-auto mr-auto mt-0 mb-0 text-center border-b-4 text-7xl text-oxford-blue">Bora treinar com quem entende e se importa</h1>
                        </div>
