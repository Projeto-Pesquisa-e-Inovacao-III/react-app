...
export default function SuccessModalMobile({closeThen, title, content }: { closeThen: React.Dispatch<React.SetStateAction<boolean>>; title?: string; content?: string }) {
    ...
    return (
        <>
            ...
            <div className="modal-event-created-mobile">
