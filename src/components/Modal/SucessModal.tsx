...
export default function SuccessModal({closeThen, title, content }: { closeThen: React.Dispatch<React.SetStateAction<boolean>>; title?: string; content?: string }) {
    ...
    return (
        <>
            ...
            <div className="modal-event-created">
