...
export default function CalendarMonthStyledMobile({ clickedDate, createdEvents }: Props) {
  ...
  return (
    <div className="container-calendar-mobile">
      <div className="wrapper-callendar" id="wrapper-styled-callendar">
        <FullCalendar
          ...
          headerToolbar={{
            ...
            end: `${selectedMonth >= actualMonth ? "" : ""}${selectedMonth - 1 >= actualMonth ? "prev" : ""}${selectedMonth != actualMonth && selectedMonth != 12 ? "," : ""}${selectedMonth == 12 ? "" : "next"}`, // gambiarra? engenharia! // ficaria "today prev,next" no caminho feliz
          }}
          height={"auto"}
