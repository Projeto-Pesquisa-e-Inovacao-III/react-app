    ...
    function getIcons() {
        ...
        if (type?.includes("personal") && !type?.includes("admin")) {
            return (<>
                ...
                <Link to="/personal/check-schedule">
                    <HeaderIconsMobile icon={
                        <Eye />
                ...
                <Link to="/users">
                    <HeaderIconsMobile icon={
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M9 11C11.2091 11 13 9.20914 13 7C13 4.79086 11.2091 3 9 3C6.79086 3 5 4.79086 5 7C5 9.20914 6.79086 11 9 11Z" stroke="#B3B3B3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    } pageTitle="Usuários" />
                </Link>
