...
export default function Layout({ children, type, changeTypeTo, hasHeader = true }: { children: React.ReactNode; type: "student" | "personal"; changeTypeTo: React.Dispatch<React.SetStateAction<"personal" | "student">>; hasHeader?: boolean }) {
